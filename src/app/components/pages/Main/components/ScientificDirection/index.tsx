    ...
    return (
        ...
        >
            ...
            <p className={s.results}>
                ...
                "Алтайвагонзавод", ОАО "Волгограднефетмаш", ООО "Forte Metals" и
                других. Каждый год специалисты кафедры участвуют в модернизации
                производства на предприятиях Российской Федерации.
            </p>
        </Container>
    )
}
